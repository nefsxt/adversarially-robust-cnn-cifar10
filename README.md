...
NOTE:
All experiments were conducted in a CPU-only environment. Due to long training times, extensive experimentation with alternative optimization configurations and learning rate schedulers was computationally constrained. Expanded experimentation and fine-tuning will be performed once GPU resources are available.
